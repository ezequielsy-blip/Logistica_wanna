...
# --- MOTOR DE UBICACIÓN (Tu lógica idéntica de PC 99 + secuencia ABCD) ---
...
# --- TAB 2: DESPACHO (Consulta libre / Salida Protegida) ---
with tab2:
...
# --- TAB 3: PLANILLA (Siempre visible) ---
with tab3:
